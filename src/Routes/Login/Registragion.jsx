            ...
            <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
              ...
              <div className="mt-5 justify-self-center">
                <label className="ms-2 text-md font-medium text-gray-900 flex">
                  ...
                  <Link to="/login">
                    <p className="text-blue-500 hover:text-blue-600">Login</p>
                  </Link>
                </label>
              </div>
              ...
              <div className="flex gap-x-5 justify-self-center my-5 ">
                <div className="w-10 bg-white rounded-full cursor-pointer">
                  <img src="public/image/google.png" alt="Google" /> 
                </div>
                <div className="w-10 bg-white rounded-full cursor-pointer">
                  <img className="rounded-full" src="public/image/facebook.png" alt="Facebook" />
                </div>
                <div className="w-10 bg-white rounded-full cursor-pointer">
                  <img src="public/image/apple.png" alt="Apple" />
                </div>
              </div>
            </form>
          </div>
