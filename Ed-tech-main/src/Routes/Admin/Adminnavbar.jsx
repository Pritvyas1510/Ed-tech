...
const Adminnavbar = () => {
    return (
      ...
      <div className="navbar-start">
        ...
        <Link to="/Adminpanal"><a className="btn btn-ghost text-xl"><img src="/public/Image/MainLogo.png" alt="Logo" className="w-12" /><p className="text-black text-4xl">Ed</p><p className="text-blue-800 text-4xl">Tech</p></a></Link>
      </div>
